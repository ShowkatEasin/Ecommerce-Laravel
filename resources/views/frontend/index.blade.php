                                ...
                                <div class="allcategories_collapse" id="allcategories_collapse">
                                    <div class="card card-body">
                                        <ul class="allcategories_list ul_li_block">
                                            <li><a href="shop_grid.html"><i class="fas fa-chevron-right"></i> New Arrival Products</a></li>
                                            <li><a href="shop_list.html"><i class="fas fa-chevron-right"></i> Most Popular Products</a></li>
                                            <li><a href="shop_grid.html"><i class="fas fa-chevron-right"></i> Deals of the day</a></li>
                                            <li><a href="shop_list.html"><i class="fas fa-chevron-right"></i> Mobile Accessories</a></li>
                                            <li><a href="shop_grid.html"><i class="fas fa-chevron-right"></i> Computer Accessories</a></li>
                                            <li><a href="shop_list.html"><i class="fas fa-chevron-right"></i> Consumer Electronics</a></li>
                                            <li><a href="shop_grid.html"><i class="fas fa-chevron-right"></i> Automobiles & Motorcycles</a></li>
                                            <li><a href="shop_list.html"><i class="fas fa-chevron-right"></i> Mobile Accessories</a></li>
                                            <li><a href="shop_grid.html"><i class="fas fa-chevron-right"></i> Computer Accessories</a></li>
                                            <li><a href="shop_list.html"><i class="fas fa-chevron-right"></i> Consumer Electronics</a></li>
                                            <li><a href="shop_grid.html"><i class="fas fa-chevron-right"></i> Automobiles & Motorcycles</a></li>
                        ...
                        <div class="col-lg-9 order-lg-3">
                            <div class="best-selling-products">
                                ...
                                <div class="product-area clearfix">
                                    ...
                                    <div class="grid">
                                        <div class="product-pic">
                                            <img src="{{ asset('frontend') }}/assets/images/shop/product-img-21.png" alt>
                                    ...
                                    <div class="grid">
                                        <div class="product-pic">
                                            <img src="{{ asset('frontend') }}/assets/images/shop/product-img-22.png" alt>
                                    ...
                                    <div class="grid">
                                        <div class="product-pic">
                                            <img src="{{ asset('frontend') }}/assets/images/shop/product-img-23.png" alt>
                                            <span class="theme-badge">Sale</span>
                                            <div class="actions">
                                                <ul>
                                                    <li>
                                    ...
                                    <div class="grid">
                                        <div class="product-pic">
                                            <img src="{{ asset('frontend') }}/assets/images/shop/product-img-24.png" alt>
                                    ...
                                    <div class="grid">
                                        <div class="product-pic">
                                            <img src="{{ asset('frontend') }}/assets/images/shop/product-img-25.png" alt>
                                            <div class="actions">
                                                <ul>
                                                    <li>
                                                        <a href="#"><svg role="img" xmlns="http://www.w3.org/2000/svg" width="48px" height="48px" viewBox="0 0 24 24" stroke="#2329D6" stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" fill="none" color="#2329D6"> <title>Favourite</title> <path d="M12,21 L10.55,19.7051771 C5.4,15.1242507 2,12.1029973 2,8.39509537 C2,5.37384196 4.42,3 7.5,3 C9.24,3 10.91,3.79455041 12,5.05013624 C13.09,3.79455041 14.76,3 16.5,3 C19.58,3 22,5.37384196 22,8.39509537 C22,12.1029973 18.6,15.1242507 13.45,19.7149864 L12,21 Z"/> </svg></a>
                                ...
                                <div class="top_category_carousel2" data-slick='{"dots": false}'>
                                        ...
                                        <div class="category_boxed">
                                            <a href="#!">
                                                  <span class="item_image">
                                                      <img src="{{ asset('frontend') }}/assets/images/categories/category_1.png" alt="image_not_found">
                                                  </span>
                                    ...
                                    <div class="slider_item">
                                        <div class="category_boxed">
                                            <a href="#!">
                                                <span class="item_image">
                                                    <img src="{{ asset('frontend') }}/assets/images/categories/category_2.png" alt="image_not_found">
                                                </span>
                                    ...
                                    <div class="slider_item">
                                        <div class="category_boxed">
                                            <a href="#!">
                                                <span class="item_image">
                                                    <img src="{{ asset('frontend') }}/assets/images/categories/category_3.png" alt="image_not_found">
                                                </span>
                                    ...
                                    <div class="slider_item">
                                        <div class="category_boxed">
                                            <a href="#!">
                                                <span class="item_image">
                                                    <img src="{{ asset('frontend') }}/assets/images/categories/category_4.png" alt="image_not_found">
                                                </span>
                                    ...
                                    <div class="slider_item">
                                        <div class="category_boxed">
                                            <a href="#!">
                                                <span class="item_image">
                                                    <img src="{{ asset('frontend') }}/assets/images/categories/category_5.png" alt="image_not_found">
                                                </span>
